...
const solucoes: Solucao[] = [
  {
    ...
    problema: "Clientes que reduziram ou pararam de comprar.",
    indicadores: "Recência, frequência, ticket, mix, receita perdida e segmento (RFM).",
    decisao: "Quais clientes recuperar primeiro — e por quê.",
    imgs: [
      "/demos/carteira.png",
